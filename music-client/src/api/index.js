...
//根据歌手名字模糊查询歌曲
export const likeSongOfName = (name) => get(`song/likeSongOfName?songName=${name}`);
...
//====================评价相关======================
//提交评价
export const setRank = (params) => get(`rank/add`,params);
//获取指定歌单平均分
export const getRankOfSongListId = (songListId) => get(`rank/sum?songListId=${songListId}`);
