<template>
    <div>
            ...
            <el-card>
                <div class="grid-content">
                    <div class="grid-cont-center">
                        ...
                        <div class="el-icon-user">用户总数</div>
                    </div>
                </div>
            </el-card>
            </el-col>
            ...
            <el-card>
                <div class="grid-content">
                    <div class="grid-cont-center">
                        ...
                        <div class="el-icon-sunny">歌曲总数</div>
                    </div>
                </div>
            </el-card>
            </el-col>  
            ...
            <el-card>
                <div class="grid-content">
                    <div class="grid-cont-center">
                        ...
                        <div class="el-icon-headset">歌手数量</div>
                    </div>
                </div>
            </el-card>
            </el-col>                      
            ...
            <el-card>
                <div class="grid-content">
                    <div class="grid-cont-center">
                        ...
                        <div class="el-icon-reading">歌单数量</div>
                    </div>
                </div>
            </el-card>
            </el-col>            
        ...
        <el-row :gutter="20" class="mgb20">
            <el-col :span="12">
                 <h3 class="mgb20" align="center" style="font-size:20px;color:#91a0bd;">用户性别比例</h3>
                <div style="background-color:white;">
                    <ve-pie :data="consumerSex" :theme="options"></ve-pie>
                </div>
            </el-col>
            <el-col :span="12">
                <h3 class="mgb20" align="center" style="font-size:20px;color:#91a0bd;">歌曲风格分布</h3>
                <div style="background-color:white;">                
                    <ve-histogram :data="songStyle" :theme="options2" ></ve-histogram>
                </div>
            </el-col>            
        </el-row>
        ...
        <el-row :gutter="20" class="mgb20">
            <el-col :span="12">
                 <h3 class="mgb20" align="center" style="font-size:20px;color:#91a0bd;">歌手性别比例</h3>
                <div style="background-color:white;">
                    <ve-pie :data="singerSex" ></ve-pie>
                </div>
            </el-col>
            <el-col :span="12">
                <h3 class="mgb20" align="center" style="font-size:20px;color:#91a0bd;">歌手国籍分布</h3>
                <div style="background-color:white;">                
